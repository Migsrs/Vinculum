...
export function Login({ onLogin }) {
  ...
  const handleLogin = async (e) => {
    ...
    clearRateLimit("login"); // login bem-sucedido — zera contador
...
export function Register() {
  ...
  const onSubmit = async (e) => {
    ...
    const newUser = {
      ...form,
      uid,
      password: hashedPwd,                  // nunca salva senha em texto puro
...
export function CompleteGoogleProfile({ onProfileSaved }) {
  ...
  const onSubmit = async (e) => {
    ...
    const newUser = {
      ...
      cpf: form.cpf.replace(/\D/g, ""),
      name: sanitizeText(form.name || pending.name || pending.email, 100),
      bio: sanitizeText(form.bio, 500),
      specialties: sanitizeText(form.specialties, 200),
      certifications: sanitizeText(form.certifications, 200),
      careNeeds: sanitizeText(form.careNeeds, 200),
